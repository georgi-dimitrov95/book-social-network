...
export function updateBookArchivedStatus(http: HttpClient, rootUrl: string, params: UpdateBookArchivedStatus$Params, context?: HttpContext): Observable<StrictHttpResponse<{
}>> {
